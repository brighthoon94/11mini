...
<table width="100%" border="0" cellspacing="0" cellpadding="0"	style="margin-top: 13px;">
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01"><%-- <%=purchase.getBuyer().getRegDate() %> --%>${purchase.orderDate}</td>
	</tr>
		...
		<td align="right">
			<table border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td background="/images/ct_btnbg02.gif" class="ct_btn01"	style="padding-top: 3px;" data-param= "${purchase.tranNo}">
						수정
					</td>
